...
<section id="auth-view" class="auth-shell <?= $logged ? 'hidden':'' ?>">
  <div class="auth-card">
    <div class="brand">
      <div class="brand-mark"><img src="assets/urs-seal.png" alt="URS"></div>
    ...
    <div id="login-panel">
      ...
      <form id="login-form">
        ...
        <label>Password<div class="password-field"><input name="password" type="password" required autocomplete="current-password"><button type="button" class="password-toggle" data-password-toggle aria-label="Show password" title="Show password">&#128065;</button></div></label>
    ...
    <div id="reset-panel" class="hidden">
      ...
      <div id="reset-result" class="demo-note hidden"></div>
      ...
      <form id="reset-password-form" class="hidden"><label>New Password<div class="password-field"><input name="password" type="password" minlength="8" required autocomplete="new-password"><button type="button" class="password-toggle" data-password-toggle aria-label="Show password" title="Show password">&#128065;</button></div></label><label>Confirm Password<div class="password-field"><input name="confirm_password" type="password" minlength="8" required autocomplete="new-password"><button type="button" class="password-toggle" data-password-toggle aria-label="Show password" title="Show password">&#128065;</button></div></label><button class="btn primary wide">Set New Password</button></form>
    ...
    <div id="register-panel" class="hidden">
      ...
      <form id="register-form" class="grid-form">
        ...
        <label>Contact No.<input name="contact_no" required></label><label>Password<div class="password-field"><input name="password" type="password" minlength="8" required><button type="button" class="password-toggle" data-password-toggle aria-label="Show password" title="Show password">&#128065;</button></div></label><label>Confirm Password<div class="password-field"><input name="confirm_password" type="password" minlength="8" required><button type="button" class="password-toggle" data-password-toggle aria-label="Show password" title="Show password">&#128065;</button></div></label>
...
<section id="app-view" class="<?= $logged ? '' : 'hidden' ?>">
  <aside class="sidebar">
    <div class="side-brand"><div class="brand-mark small"><img src="assets/urs-seal.png" alt="URS"></div><div><b>CCS Clearance</b><small>Student System</small></div></div>
  ...
  <main class="main">
    <header class="topbar">
      ...
      <div class="top-actions"><span id="term">AY 2025-2026</span><button class="icon-btn" id="notifications" type="button" aria-label="Notifications" title="Notifications">&#128276;<span class="notification-dot"></span></button><div class="profile-menu"><button class="avatar" id="avatar" aria-label="Open profile menu" aria-expanded="false"></button><div id="profile-dropdown" class="profile-dropdown hidden"><b id="profile-name"></b><span id="profile-role"></span><button type="button" data-profile-page="settings">Account settings</button><button type="button" id="profile-logout">Sign out</button></div></div></div>
    </header>
